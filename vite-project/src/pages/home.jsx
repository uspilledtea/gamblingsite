...
export function Home() {
    return(
        <>
        <div className="w-screen bg-slate-900 h-12"> 
        ...
        <Link to="/Login" className="text-slate-300 transition ease-in-out delay-100 hover:text-slate-500 mt-2.5 w-10">Login</Link>
        </div>
        </>
    )
}
